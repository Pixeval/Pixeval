...
namespace Pixeval.Data.Web.Response
{
    public class FollowingResponse
    {
        ...
        public class UserPreview
        {
            ...
            [JsonProperty("novels")] public List<Novel> Novels { get; set; }
        ...
        public class Illust
        {
            ...
            [JsonProperty("tags")] public List<IllustTag> Tags { get; set; }
        ...
        public class Novel
        {
            ...
            [JsonProperty("tags")] public List<NovelTag> Tags { get; set; }

            [JsonProperty("page_count")] public long PageCount { get; set; }

            [JsonProperty("text_length")] public long TextLength { get; set; }
            ...
            [JsonProperty("total_comments")] public long TotalComments { get; set; }

            [JsonProperty("is_muted")] public bool IsMuted { get; set; }

            [JsonProperty("is_mypixiv_only")] public bool IsMypixivOnly { get; set; }

            [JsonProperty("is_x_restricted")] public bool IsXRestricted { get; set; }
        }
