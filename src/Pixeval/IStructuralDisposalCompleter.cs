...
public interface IPageDisposalCompleter
{
...
{
    IStructuralDisposalCompleter? ParentCompleter => FindParentCompleterRecursively(this as Control);
    ...
    private static IStructuralDisposalCompleter? FindParentCompleterRecursively(Control? uiElement)
    {
        return uiElement?.FindAncestorOfType<IStructuralDisposalCompleter>();
    }
}
