...
public partial class IntAppSettingsEntry(AppSettings appSettings, Expression<Func<AppSettings, int>> property)
    : SingleValueSettingsEntry<AppSettings, int>(appSettings, property), IDoubleSettingsEntry
{
