...
{
    public static readonly DirectProperty<McpHelpSection, string> McpToolsStatusProperty =
        AvaloniaProperty.RegisterDirect<McpHelpSection, string>(nameof(McpToolsStatus), static section => section.McpToolsStatus);
