...
// 
// Pixeval/Pixeval
// Copyright (c) 2022 Pixeval/RecentPostsPage.xaml.cs
// 
...
public sealed partial class RecentPostsPage : ISortedIllustrationContainerPageHelper
{
    ...
    public override void OnPageActivated(NavigationEventArgs navigationEventArgs)
    {
        ...
        WeakReferenceMessenger.Default.Register<RecentPostsPage, MainPageFrameNavigatingEvent>(this, static (recipient, _) => recipient.IllustrationContainer.ViewModel.DataProvider.FetchEngine?.Cancel());
    }
    ...
    {
        _ = IllustrationContainer.ViewModel.ResetEngineAndFillAsync(App.AppViewModel.MakoClient.RecentPosts(PrivacyPolicyComboBox.GetComboBoxSelectedItemTag(PrivacyPolicy.Public)));
    }
