...
[MetaPathMacro]
public class IsPostGroupMacro : IPredicate<WorkSubscriptionDownloadContext>
{
    public string Name => "is_post_group";
    ...
    public bool Match(WorkSubscriptionDownloadContext context) =>
        context is { IsGroup: true, SubscriptionType: WorkSubscriptionType.Posts };
}
