...
[MetaPathMacro]
public class SeriesIdMacro : ITransducer<IArtworkInfo>, IContextRestrictedMacro
{
    public string Name => "series_id";

    public string Description => I18NManager.GetResource(MacroParserResources.MacroDescription.SeriesId);
