Pixeval's work subscription feature can automatically download works published or bookmarked by a specific user, or works in a manga/novel series.
...
On the "Posts", "Bookmarks", or "Series" works page, you can click the "More" button on the right side of the toolbar to quickly subscribe to the current category of works.

You can also manually specify a user or series ID, subscription type, and work category in Settings to add a subscription.

When subscribing to your own bookmarks, both public and private bookmarks will be downloaded.

## Download Timing and Behavior

When you add a new subscription, Pixeval will immediately download it.
