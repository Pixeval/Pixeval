...
// 
// Pixeval/Pixeval
// Copyright (c) 2021 Pixeval/SearchTagMatchOptionWrapper.cs
// 
...
{
    public record SearchTagMatchOptionWrapper(SearchTagMatchOption Value, string LocalizedString) : ILocalizedBox<SearchTagMatchOption>
    {
