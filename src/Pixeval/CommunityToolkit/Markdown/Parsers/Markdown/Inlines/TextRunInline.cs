    ...
    public class TextRunInline : MarkdownInline, IInlineLeaf
    {
        ...
        internal static TextRunInline Parse(string markdown, int start, int end)
        {
            ...
            while (searchPos < end)
            {
                ...
                var sequenceStartIndex = markdown.IndexOfAny(new[] { '\\', '&' }, searchPos, end - searchPos);
                ...
                if (markdown[sequenceStartIndex] == '\\')
                {
                    ...
                    var decodedChar = markdown[sequenceStartIndex + 1];
                ...
                else if (markdown[sequenceStartIndex] == '&')
                {
                    ...
                    var semicolonIndex = markdown.IndexOf(';', sequenceStartIndex + 1, end - (sequenceStartIndex + 1));
                    ...
                    var entityName = markdown.Substring(sequenceStartIndex + 1, semicolonIndex - (sequenceStartIndex + 1));
        ...
        internal static string ResolveEscapeSequences(string markdown, int start, int end)
        {
            ...
            {
                // Look for the next backslash.
                var sequenceStartIndex = markdown.IndexOf('\\', searchPos, end - searchPos);
                if (sequenceStartIndex == -1)
                {
                    break;
                }
