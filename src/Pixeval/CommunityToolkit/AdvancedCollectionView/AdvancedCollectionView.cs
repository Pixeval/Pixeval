...
namespace Pixeval.CommunityToolkit.AdvancedCollectionView
{
    ...
    public partial class AdvancedCollectionView : IAdvancedCollectionView, INotifyPropertyChanged, ISupportIncrementalLoading, IComparer<object>
    {
                ...
                if (_source is INotifyCollectionChanged sourceNcc)
                {
                    _sourceWeakEventListener =
                        new WeakEventListener<AdvancedCollectionView, object, NotifyCollectionChangedEventArgs>(this)
                        {
                            ...
                            OnEventAction = (_, _, arg3) => SourceNcc_CollectionChanged(arg3),

                            // The source doesn't exist anymore
                            OnDetachAction = _ => sourceNcc.CollectionChanged -= _sourceWeakEventListener!.OnEvent
                        };
        ...
        */
        ...
        private void SourceNcc_CollectionChanged(NotifyCollectionChangedEventArgs e)
        {
        ...
        private bool HandleItemAdded(int newStartingIndex, object? newItem, int? viewIndex = null)
        {
            ...
            var e = new VectorChangedEventArgs(CollectionChange.ItemInserted, newViewIndex);
            OnVectorChanged(e);
            return true;
        }
        ...
        private void RemoveFromView(int itemIndex)
        {
            ...
            var e = new VectorChangedEventArgs(CollectionChange.ItemRemoved, itemIndex);
            OnVectorChanged(e);
        }
