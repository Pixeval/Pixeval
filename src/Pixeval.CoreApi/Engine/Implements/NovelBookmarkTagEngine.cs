...
// Copyright (c) 2024 Pixeval.CoreApi/NovelBookmarkTagEngine.cs
// 
    ...
    : AbstractPixivFetchEngine<BookmarkTag>(makoClient, engineHandle)
{
    ...
    {
        return RecursivePixivAsyncEnumerators.BookmarkTag<NovelBookmarkTagEngine>
            .WithInitialUrl(this, MakoApiKind.AppApi,
                engine => "/v1/user/bookmark-tags/novel"
                          + $"?user_id={engine._uid}"
