...
public static class Enumerates
{
    ...
    public static V ComputeAndPutIfAbsent<K, V>(this IDictionary<K, V> dic, K item, Func<V> valueFactory)
    {
        return dic.TryGetValue(item, out var v) ? v : dic[item] = valueFactory();
    }
}
