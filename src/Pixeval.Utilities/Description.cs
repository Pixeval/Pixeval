...
public static class DescriptionHelper
{
    ...
    {
        return typeof(TEnum).GetField(@enum.ToString())?.GetCustomAttribute<DescriptionAttribute>()?.Description ?? throw new InvalidOperationException("Attribute not found");
    }
}
