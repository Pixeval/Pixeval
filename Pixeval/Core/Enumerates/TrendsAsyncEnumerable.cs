...
namespace Pixeval.Core.Enumerates
{
    ...
    public class TrendsAsyncEnumerable : AbstractPixivAsyncEnumerable<Trends>
    {
        ...
        private class TrendsAsyncEnumerator : AbstractPixivAsyncEnumerator<Trends>
        {
            ...
            {
                // just consider this function is a black box, leave the impl alone, and do not try to maintain/refactor it
            ...
            private static async Task<HttpResponse<string>> GetResponse(string url)
            {
                ...
                return !result.IsNullOrEmpty() ? HttpResponse<string>.Wrap(true, result) : HttpResponse<string>.Failure;
            }
        }
